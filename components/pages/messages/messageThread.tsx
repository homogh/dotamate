...
/** Direct-message thread — the /dashboard/messages/[id] page, and the chat pane of /dashboard/friends. */
export function MessageThread({ conversationId }: { conversationId: string | number }) {
  ...
  return (
    <div className="flex h-full min-h-0 w-full flex-1 flex-col">
      ...
      <div className="flex min-h-0 flex-1 flex-col gap-4 overflow-y-auto p-6 md:p-10">
        {messages.length === 0 ? (
