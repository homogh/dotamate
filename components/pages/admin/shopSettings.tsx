    ...
    <div className="flex w-full flex-col gap-6 p-6 md:p-8">
      <Card tone="surface" noHover className="w-full gap-5 p-6">
        ...
        <p className="w-full text-right text-[14px] leading-[1.7] text-text-dim" dir="auto">
          با روشن کردن این گزینه، لینک «فروشگاه» در منوی بالای سایت ظاهر می‌شود و کاربران می‌توانند وارد فروشگاه شوند. وقتی خاموش است، فروشگاه برای همه کاربران کاملاً بسته است و ورود مستقیم با آدرس هم صفحه ۴۰۴ نشان می‌دهد. فقط شما (مدیر کل) برای پیش‌نمایش و تکمیل فروشگاه همچنان به آن دسترسی دارید.
        </p>
      ...
      <Card tone="surface" noHover className="w-full gap-5 p-6">
        ...
        <p className="w-full text-right text-[14px] leading-[1.7] text-text-dim">
          وقتی خاموش است، هیچ اثری از بازار کاربران برای کاربران باقی نمی‌ماند: بخش و دسته آن از فروشگاه، «آگهی‌های من» و «فروش‌های من» از پنل کاربر، سفارش‌های بازار و اعلان‌هایش حذف می‌شوند و ورود با آدرس هم ۴۰۴ می‌دهد. فقط شما (مدیر کل) برای پیش‌نمایش به آن دسترسی دارید.
